...
- First name, surname, maiden name, last name, username, title, date of birth, gender, picture, social security number, tax identification number, password, and copies of ID cards or other forms of identification.

### 2.2 Contact Data

- Home address, work address, billing address, email address, and telephone numbers.

### 2.3 Professional Background Data

- Educational and professional history, interests, and accomplishments.

### 2.4 Online Presence Data

- Links to your public account pages on social media websites, personal websites, and other online materials related to you.

### 2.5 Content Data

- Any content you post to the Services, including profiles, questions, preference settings, answers, messages, comments, and metadata (e.g., timestamps).

### 2.6 Marketing and Communications Data

- Your preferences in receiving marketing from us and third parties, as well as your communication preferences.
- Content of emails or messages sent through the Services.

### 2.7 Behavioral Data

- Inferred or assumed information about your behavior and interests, based on your online activity (e.g., grouped into "segments").

### 2.8 Technical Data

- Internet protocol (IP) address, geolocation data, login data, browser type and version, time zone setting, browser plug-in types and versions, operating system, platform, and other technology on the devices you use to access the Site or Services.
...
- **Right to Data Portability:** You have the right to request transfer of your personal data to another controller under certain conditions.
...
- **Right to Complain:** You have the right to lodge a complaint with a supervisory authority if you believe that we have not complied with applicable data protection laws.
...
- **Right to Withdraw Consent:** You have the right to withdraw your consent at any time, where we rely on your consent to process your personal data.
- **Right to Object to Direct Marketing:** You have the right to object to processing of your personal data for direct marketing purposes.
- **Right to Object to Profiling:** You have the right to object to processing of your personal data for profiling purposes.
- **Right to Not Be Subject to Automated Decision-Making:** You have the right not to be subject to a decision based solely on automated processing, including profiling, which produces legal effects concerning you or similarly significantly affects you.
...
> **Key Point:** Under GDPR and Polish law, you can access, correct, delete, restrict, transfer, object to processing, and withdraw consent for your data.

Under the GDPR and Polish law, you have the following rights regarding your personal data:
...
- **Data Portability:** Request a transfer of your data to another controller.
- **Objection:** Object to processing based on legitimate interests.
- **Withdraw Consent:** Withdraw consent at any time, where applicable.

To exercise these rights, please contact us at [support@getonepass.eu](mailto:support@getonepass.eu).

## 7. Data Storage and International Data Transfers
...
We use the following third-party services to support our operations:

- **Google Analytics:** For analyzing website traffic and user behavior.
- **Stripe:** For processing payments.
- **TinyBird:** For data analytics and processing.
- **OneSignal:** For sending notifications and communications.
- **Google LLC:** For cloud storage, analytics, and other services.

These third-party services may collect and process your personal data in accordance with their own privacy policies. We recommend reviewing their policies for more information.
...
> **Key Point:** Contact us at privacy@getonepass.eu with any questions about this policy or your data.
...
> **Key Point:** This section clarifies the specialized terminology used throughout this Privacy Policy.
